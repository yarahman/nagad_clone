      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: <BottomNavigationBarItem>[
          BottomNavigationBarItem(
            icon: ImageIcon(const AssetImage("assets/ic_home_active.png"), color: item1color, size: 25,),
            label: 'Home',
          ),
          BottomNavigationBarItem(
            icon: ImageIcon(const AssetImage("assets/ic_transactions_active.png"), color: item2color, size: 25,),
            label: 'Transactions',
          ),
          BottomNavigationBarItem(
            icon: ImageIcon(const AssetImage("assets/ic_people.png"), color: item3color, size: 25,),
            label: 'People',
          ),
          BottomNavigationBarItem(
            icon: ImageIcon(const AssetImage("assets/ic_my_nagad.png"), color: item4color, size: 25,),
            label: 'My Nagad',
          ),
        ],
