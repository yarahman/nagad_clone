      ...
      body: SingleChildScrollView(
        ...
        child: Column(children: [
          Padding(
            ...
            child: Row(children: [const Expanded(child: Padding(padding: EdgeInsets.only(left: 12.0), child: Text("Services",style: TextStyle(
          ...
          Padding(
            ...
            child: Row(children: const [Expanded(child: Padding(padding: EdgeInsets.only(left: 12.0), child: Text("Payment",style: TextStyle(
              color: Colors.black45,fontWeight: FontWeight.normal,),)),)],),
          ),
          Container(
            color: Colors.white,
